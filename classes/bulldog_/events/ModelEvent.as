...
package bulldog.events 
{
	...
	public class ModelEvent extends Event 
	{
		 ...
		 * @default
		 */
		public var XmlConfig:XMLList;
		
		/**
		 * Construtor ModelEvent
		 * 
		 * @param type:String.
		 * @param pXmlList:XMLList
		 * @param bubbles:Boolean
		 * @param cancelable:Boolean
		 */
		public function ModelEvent(type:String, pXmlList:XMLList = null ,bubbles:Boolean=false, cancelable:Boolean=false) 
		{ 
			XmlConfig = pXmlList;
		...
		{ 
			return new ModelEvent(type,XmlConfig, bubbles, cancelable);
		} 
